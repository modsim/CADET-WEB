...
name = "Chromatogram Inlet"

depends_performance = []
depends_sensitivity = []
file_name = 'chromatogram_inlet.png'
file_name_csv = 'chromatogram_inlet.csv'
file_name_xls = 'chromatogram_inlet.xlsx'
...
def generate_csv(hdf5_path):
    ...
    for idx, comp in enumerate(components):
        ...
        try:
            data[comp] = h5['/output/solution/SOLUTION_COLUMN_INLET_COMP_%03d' % idx]
        except KeyError:
            data[comp] = h5['/output/solution/unit_001/SOLUTION_COLUMN_INLET_COMP_%03d' % idx]
...
def get_data(hdf5_path):
    ...
    solution_values = np.array(h5['/web/compress/INLET'])
